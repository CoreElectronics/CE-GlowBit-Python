...
class glowbit(colourFunctions):
    ...
    # 
    # Note that several GlowBit library methods call this method unconditionally (eg: blankDisplay ) or optionally (eg: by passing the update = True parameter to stick.graph1D() )
    def pixelsShow(self):
        return
